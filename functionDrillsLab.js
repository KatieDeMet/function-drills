...
let colorRating = faveColorFinder('rainbow');
...
function theEliminator(contestant1, contestant2) {
...
let totalFrogs2 = buyChocolateFrogs(12)
console.log(totalFrogs)
